...
function fnInitializeGlorpEffects(){
	...
	array_set(glorp_effects_meta, GlorpEffects.GlorpTax, new GlorpMeta(GlorpEffects.GlorpTax, "Glorp Tax", "Takes 20% of your earnings for the next {TURNS}.", [3, 5, 10]));
	array_set(glorp_effects_meta, GlorpEffects.CodeMichi, new GlorpMeta(GlorpEffects.CodeMichi, "Code Michi", "Shop prices are 10% off for the next {TURNS}.", [3, 5, 10]));
	...
	array_set(glorp_effects_meta, GlorpEffects.BigDickEnergy, new GlorpMeta(GlorpEffects.BigDickEnergy, "Big Dick Energy", "Transforms all Michi symbols from the {WHEELS} into Michock symbols for the next {TURNS}.", [3, 5, 10]));
	...
	array_set(glorp_effects_meta, GlorpEffects.FreeBits, new GlorpMeta(GlorpEffects.FreeBits, "Bits are free!", "At the end of the next {TURNS}, earn 5 additional coins.", [3, 5]));
